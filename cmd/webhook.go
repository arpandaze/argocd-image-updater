...
`,
	...
	webhookCmd.Flags().StringVar(&webhookCfg.AzureACRSecret, "azure-acr-webhook-secret", env.GetStringVal("AZURE_ACR_WEBHOOK_SECRET", ""), "Secret for validating Azure ACR webhooks")
